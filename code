{
  "title": "QRScout Prime Movers",
  "page_title": "Rebuilt Scoring Prime Movers",
  "delimiter": "\t",
  "teamNumber": 31,
  "floatingField": {
    "show": false,
      ...
      "fields": [
        {
          ...
          "actions": [
            ...
            {
              "label": "Outpost Collect",
              "code": "outpost_collect"
            },
            {
              "label": "Ground Collect",
              "code": "ground_collect"
            },
            {
              "label": "Passing",
